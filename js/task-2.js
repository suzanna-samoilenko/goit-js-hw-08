...
function createImagesGallery(img) {
  return img
    .map(
      image => `<li class="gallery-item">
      <img class="gallery-img" src="${image.url}" alt="${image.alt}" width="360" height="300">
      </li>`
    )
    .join('');
}

imagesList.insertAdjacentHTML('beforeend', createImagesGallery(images));
